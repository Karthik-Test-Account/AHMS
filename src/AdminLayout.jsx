...
const adminNavMenus = [
  ...
  { text: 'Invoices', icon: <FontAwesomeIcon icon={faMoneyBill1} />, to: '/admin/invoices' },
  { text: 'Complaints', icon: <SentimentVeryDissatisfiedIcon />, to: '/admin/complaints' },
  { text: 'Suggestions', icon: <FontAwesomeIcon icon={faStar} />, to: '/admin/suggestions' },
