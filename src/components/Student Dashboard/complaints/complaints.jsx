        ...
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            <Box component="main" sx={{
                ...
                <Grid container gap={2} sx={{
                    ...
                    <Grid item>
                        <Typography variant="h3" fontWeight={600} align="center">Complaints</Typography>
                    </Grid>
                    <Grid item sx={{ width: "100%" }}>
                        <Grid container gap={1} sx={{
                            ...
                            <Grid item sx={{
                                ...
                                <Grid item>
                                    <Typography variant='h6' sx={{ fontWeight: 'bold', }}>Your complaint type</Typography>
                                </Grid>
                                <Grid item>
                                ...
                                <Grid item sx={{}}>
                                    <Button variant="contained" fullWidth sx={{ height: '50px', marginTop: '10px' }} onClick={handleClick}>Make complaint</Button>
                                </Grid>
                            </Grid>
                            <Grid item sx={{
                                backgroundColor: "#080808",
                                ...
                                <Grid item>
                                    <Typography variant='h6' sx={{ fontWeight: 'bold', }}>Registered complaints</Typography>
                                </Grid>
                                <Grid container sx={{
                                    width: "100%",
                                    display: "flex",
                                    ...
                                    {userComplaint.map((currentrecord) => (
                                        <Complaintstext key={currentrecord.id} title={currentrecord.complainttype} dates={currentrecord.datetime} lefticon={<ErrorOutlineRoundedIcon />} righticon={<DoneIcon />} />
                                    ))}
